...
async function configure_socketio(db_connection, games_result) {
   io.on("connection", (socket) => {
	...
	if (room_size==0) {console.log("All players have left game now")}; //TODO: should we terminate the room? Or is that happening elsewhere and hence the undefined error?
