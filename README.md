...
- [ ] Can we siphon off the server console.logs for post action review? Use a logging addon?
- [ ] Can we create a spoofing detector?
  - [ ] either accuracy checker for the chrome dev console?
  - [ ] or lack of movement detector?
